...
public class ChessBoardPanel extends JPanel {
    ...
    private void loadChessPiecesPNG() {
        try {
            //URL url = Objects.requireNonNull(this.getClass().getResource("/Users/cpedda26/Desktop/Arcade-master/src/me/Chanadu/Chess"));
            chessPiecesPNG = new ImageIcon("/Users/cpedda26/Desktop/Arcade-master/src/me/Chanadu/Chess/Chess/Chess Pieces.png").getImage();
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    private void splitChessPiecesPNG() {
        ...
        BufferedImage BIChessPieces = null;
        try {
            BIChessPieces = ImageIO.read(new File("/Users/cpedda26/Desktop/Arcade-master/src/me/Chanadu/Chess/Chess Pieces.png"));
        } catch (IOException e) {
